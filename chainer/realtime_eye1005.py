...
class CNN(Chain):
    def __init__(self):
        ...
        with self.init_scope():
            ...
            self.conv3 = L.Convolution2D(None, 50, 5)
            self.l1 = L.Linear(None,1000)
            self.l1_1 = L.Linear(None, 500)
    ...
    def __call__(self, x):
        ...
        h = F.dropout(F.relu(self.l1_1(h)), 0.5)
        h = self.l2(h)
        return h
...
load_npz('eye1005.npz', model, strict=True)#Accuracy89.9%
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for idx, person in enumerate(notations):
            ...
            cv2.putText(frame, "look", (18, 400),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 255), 2)
            cv2.putText(frame, "non-look", (16, 425),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
            cv2.line(frame,(110,400),(110+90*k[person],400),
                     (255,0,255),10)
            cv2.line(frame, (110, 425), (110+90*l[person], 425),
                     (255, 255, 0), 10)
